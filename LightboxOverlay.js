...
export default class LightboxOverlay extends Component {
    ...
    this._panResponder = PanResponder.create({
      ...
      onPanResponderRelease: (evt, gestureState) => {
        if(Math.abs(gestureState.dy) > DRAG_DISMISS_THRESHOLD) {
          ...
          Animated.spring(
            this.state.pan,
            { toValue: 0, useNativeDriver: false, ...this.props.springConfig }, {useNativeDriver: false}
  ...
  open = () => {
    ...
    Animated.spring(
      this.state.openVal,
      { toValue: 1, useNativeDriver: false, ...this.props.springConfig }, {useNativeDriver: false}
    ).start(() => {
